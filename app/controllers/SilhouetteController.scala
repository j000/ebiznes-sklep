...
abstract class SilhouetteController(
  override protected val controllerComponents: DefaultSilhouetteControllerComponents,
  ...
  def passwordHasherRegistry: PasswordHasherRegistry =
    controllerComponents.passwordHasherRegistry
  ...
  def credentialsProvider: CredentialsProvider =
    controllerComponents.credentialsProvider
