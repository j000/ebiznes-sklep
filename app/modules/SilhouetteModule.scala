...
import models.OAuth2InfoModel.OAuth2InfoRepository
import models.PasswordInfoModel.PasswordInfoRepository
import models.UserModel.UserRepository
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  override def configure(): Unit = {
    ...
    bind[FingerprintGenerator]
      .toInstance(new DefaultFingerprintGenerator(false))
  ...
  @Provides
  def passwordInfoClassTag(
  ): ClassTag[PasswordInfo] = ClassTag[PasswordInfo](PasswordInfo.getClass)
  ...
  @Provides
  def oAuth2InfoClassTag(
  ): ClassTag[OAuth2Info] = ClassTag[OAuth2Info](OAuth2Info.getClass)
